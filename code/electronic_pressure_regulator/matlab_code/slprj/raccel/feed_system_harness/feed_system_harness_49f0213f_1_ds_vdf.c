...
#include "feed_system_harness_49f0213f_1_ds_vdf.h"
...
int32_T feed_system_harness_49f0213f_1_ds_vdf ( const NeDynamicSystem * LC ,
const NeDynamicSystemInput * t1 , NeDsMethodOutput * out ) { static boolean_T
_cg_const_1 [ 121 ] = { false , false , true , true , true , true , false ,
...
false , false , false , false , true , true , true , true } ; int32_T i ; ( void
) t1 ; ( void ) LC ; for ( i = 0 ; i < 121 ; i ++ ) { out -> mVDF . mX [ i ]
