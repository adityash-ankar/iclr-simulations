...
#endif
#include "nesl_rtw.h"
#include "feed_system_harness_49f0213f_1.h"
#include "feed_system_harness_49f0213f_1_gateway.h"
void feed_system_harness_49f0213f_1_gateway ( void ) { NeModelParameters
modelparams = { ( enum NeSolverTypeTag ) 0 , 0.001 , 0.001 , 0.001 , TRUE ,
FALSE , ( enum NeModifyAbsTolTag ) 2 , 0.001 , 0.0 , FALSE , FALSE , FALSE ,
( enum SscLoggingSettingTag ) 1 , 709480572.0 , FALSE , FALSE , FALSE } ;
