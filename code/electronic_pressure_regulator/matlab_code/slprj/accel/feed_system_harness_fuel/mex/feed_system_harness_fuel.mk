...
MODEL                   = feed_system_harness_fuel
MODULES                 = feed_system_harness_fuel_acc.c feed_system_harness_fuel_acc_data.c rtGetInf.c rt_nonfinite.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\feed_system_harness_fuel_acc.mexw64
MAKEFILE                = feed_system_harness_fuel.mk
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:feed_system_harness_fuel_acc.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
MODELLIB                  = feed_system_harness_fuel_acc.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = feed_system_harness_fuel_ref.rsp
COMPILER_COMMAND_FILE     = feed_system_harness_fuel_comp.rsp
...
feed_system_harness_fuel_acc.obj : $(START_DIR)\slprj\accel\feed_system_harness_fuel\feed_system_harness_fuel_acc.c
	@cmd /C echo ### Compiling "$(START_DIR)\slprj\accel\feed_system_harness_fuel\feed_system_harness_fuel_acc.c"
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\feed_system_harness_fuel\feed_system_harness_fuel_acc.c

feed_system_harness_fuel_acc_data.obj : $(START_DIR)\slprj\accel\feed_system_harness_fuel\feed_system_harness_fuel_acc_data.c
	@cmd /C echo ### Compiling "$(START_DIR)\slprj\accel\feed_system_harness_fuel\feed_system_harness_fuel_acc_data.c"
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\feed_system_harness_fuel\feed_system_harness_fuel_acc_data.c

rtGetInf.obj : $(START_DIR)\slprj\accel\feed_system_harness_fuel\rtGetInf.c
	@cmd /C echo ### Compiling "$(START_DIR)\slprj\accel\feed_system_harness_fuel\rtGetInf.c"
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\feed_system_harness_fuel\rtGetInf.c

rt_nonfinite.obj : $(START_DIR)\slprj\accel\feed_system_harness_fuel\rt_nonfinite.c
	@cmd /C echo ### Compiling "$(START_DIR)\slprj\accel\feed_system_harness_fuel\rt_nonfinite.c"
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\feed_system_harness_fuel\rt_nonfinite.c
