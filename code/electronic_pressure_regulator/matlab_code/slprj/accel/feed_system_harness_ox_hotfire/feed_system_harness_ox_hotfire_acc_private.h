#ifndef feed_system_harness_ox_hotfire_acc_private_h_
#define feed_system_harness_ox_hotfire_acc_private_h_
#include "rtwtypes.h"
...
feed_system_harness_ox_hotfire_acc_rt_TDelayInterpolate ( real_T tMinusDelay
