...
if __name__ == "__main__":
    ...
    #Define feed system parameters
    n2_tank_pressure = bar2Pa(100) # bar
    ox_ereg_out_pressure = bar2Pa(70) # bar
    fuel_ereg_out_pressure = bar2Pa(70) # bar
    chamber_pressure = bar2Pa(24) # bar
    nozzle_exit_pressure = bar2Pa(1) # bar
   ...
   #Run simulations for coupled feed system
